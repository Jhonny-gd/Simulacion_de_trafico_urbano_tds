<template>
  <v-container fluid class="pa-6" style="background:#150d3a; min-height:100vh;">
    
    <h1 class="text-white mb-6">Simulación de Tráfico Urbano</h1>

    <v-row>
      <v-col cols="4">
        <v-card class="pa-4" color="#25165c">
    ...
    <v-row class="mt-6">
      <v-col cols="12">
        <v-card height="300" color="#25165c" class="d-flex align-center justify-center">
